...
const ExperienceBookingPage = () => {
    ...
    // Recuperamos los datos de la experiencia
        ...
        <div className="bg-[#F9F9F7] min-h-screen font-sans selection:bg-[#2C342C] selection:text-white">
            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    {/* COLUMNA IZQUIERDA: RESUMEN DE EXPERIENCIA */}
                    <div className="md:col-span-1">
                        <div className="bg-white p-6 rounded-[2rem] shadow-lg border border-[#2C342C]/5 sticky top-32">
                            ...
                            <h2 className="font-serif text-2xl text-[#2C342C] mb-1 leading-tight">{experienceData.title}</h2>
                            <p className="text-xs text-[#C5A880] font-bold uppercase tracking-widest mb-4">{experienceData.subtitle}</p>
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {step === 1 && (
                                ...
                                >
                                    ...
                                    <p className="text-gray-500 mb-8 leading-relaxed">
                                        Las experiencias de Alyvia están diseñadas exclusivamente para nuestros huéspedes.
                                    </p>
                                    ...
                                    <div className="bg-[#F2F0E9] border border-[#C5A880]/30 p-4 rounded-xl mb-8 flex gap-3 items-start">
                                        ...
                                        <div>
                                            <p className="text-xs font-bold uppercase tracking-widest text-[#2C342C] mb-1">Demo Experiencias</p>
                            ...
                            {step === 2 && (
                                ...
                                >
                                    ...
                                    <h1 className="font-serif text-3xl md:text-4xl text-[#2C342C] mb-2">Detalles de Aventura</h1>
                                    <p className="text-gray-500 mb-8 text-sm">
                                        Personaliza tu experiencia para la <strong>Familia {guestInfo.lastName}</strong>.
                                    </p>
                                    ...
                                    <form onSubmit={handleBooking} className="space-y-6">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <label className="text-xs font-bold uppercase tracking-widest text-gray-400 block mb-2">Horario</label>
                                                <div className="relative">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="07:00">07:00 AM (Amanecer)</option>
                                                        <option value="09:00">09:00 AM</option>
                                                        <option value="11:00">11:00 AM</option>
                                                        <option value="15:00">03:00 PM</option>
                                                        <option value="17:00">05:00 PM (Atardecer)</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <label className="text-xs font-bold uppercase tracking-widest text-gray-400 block mb-2">Participantes</label>
                                            <div className="relative">
                                                <Users className="absolute left-4 top-3.5 text-gray-300" size={18} />
                                                <select
                                                    className="w-full bg-[#F9F9F7] border border-gray-200 rounded-xl py-3 pl-12 pr-4 focus:outline-none focus:border-[#C5A880] text-sm text-gray-600 appearance-none"
                                                    value={bookingDetails.participants}
                                                    onChange={e => setBookingDetails({ ...bookingDetails, participants: e.target.value })}
                                                >
                                                    {[1, 2, 3, 4, 5, 6].map(n => (
                                        ...
                                        <div>
                                            <label className="text-xs font-bold uppercase tracking-widest text-gray-400 block mb-2">Notas / Requerimientos</label>
                                            <textarea
                                                rows="2"
                                                ...
                                                placeholder="Ej: Necesito equipo talla S, prefiero ruta fácil..."
                                        ...
                                        >
                                            {loading ? "Agendando..." : "Confirmar Aventura"}
                                        </button>
                                    </form>
                                </motion.div>
                            )}
                            ...
                            {step === 3 && (
                                ...
                                >
                                    ...
                                    <p className="text-gray-500 max-w-md mb-8 leading-relaxed">
                                        Tu experiencia <strong>{experienceData.title}</strong> ha sido programada. Nuestro equipo te contactará para ultimar detalles.
                                    </p>

                                    <div className="flex items-center justify-center gap-2 text-xs text-gray-400 mb-8 bg-[#F9F9F7] px-4 py-2 rounded-full">
                                        <MapPin size={14} />
                                        <span>Punto de encuentro: Lobby Principal</span>
                                    </div>

                                    <div className="bg-[#F9F9F7] px-6 py-3 rounded-lg mb-8 border border-dashed border-gray-300 w-full max-w-xs">
                                        <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Ticket ID</p>
                                        <p className="font-mono text-lg text-[#2C342C]">EXP-{Math.floor(Math.random() * 10000)}</p>
                                    </div>
                                    <button
                                        onClick={() => navigate('/')}
