...
const About = () => {
    ...
    return (
        <section id="nosotros" className="bg-cream py-32 relative overflow-hidden">
            {/* SVG Decorativo (Optimizado: opacity baja para que el navegador no se esfuerce en renderizarlo perfecto) */}
            <div className="absolute top-20 left-10 md:left-1/4 opacity-10 pointer-events-none will-change-transform">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative z-10">
                    <motion.span
                        ...
                        viewport={{ once: true, margin: "-100px" }} // Margen para activar antes
                    ...
                    <motion.h2
                        ...
                        transition={{ duration: 0.6, delay: 0.1 }} // Delay reducido
                    ...
                    <motion.p
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.6, delay: 0.2 }} // Delay reducido
                ...
                <div className="relative h-[600px] w-full hidden md:block">
                    <motion.div
                        initial={{ opacity: 0, scale: 0.95 }} // Escala menos drástica
                        whileInView={{ opacity: 1, scale: 1 }}
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.8 }}
                        className="absolute top-0 right-0 w-4/5 h-[450px] overflow-hidden rounded-[2rem] will-change-transform" // Optimización GPU
                    >
                        <img
                            src={img1}
                            alt="Pool"
                            loading="lazy"
                            decoding="async" // CLAVE PARA PERFORMANCE
                            className="w-full h-full object-cover hover:scale-105 transition-transform duration-700 will-change-transform"
                        />
                    </motion.div>

                    <motion.div
                        initial={{ opacity: 0, y: 50 }} // Menos distancia
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, margin: "-50px" }}
                        transition={{ duration: 0.8, delay: 0.2 }}
                        className="absolute bottom-10 left-0 w-3/5 h-[350px] overflow-hidden rounded-[2rem] border-8 border-cream shadow-2xl will-change-transform"
                    >
                        <img
                            src={img2}
                            alt="Nature"
                            loading="lazy"
                            decoding="async" // CLAVE
                ...
                <div className="block md:hidden mt-8">
                    <div className="rounded-[2rem] overflow-hidden h-[400px] shadow-lg">
                        <img src={img1} alt="Resort" loading="lazy" decoding="async" className="w-full h-full object-cover" />
                    </div>
                </div>
